...
function detectPaint() {
	var detected=false;
	for (var i=0;i<paintDetect.length && !detected;i++) {
		var pt=paintDetect[i].globalToLocal(stage.mouseX, stage.mouseY); //xxx kan inte detta göras en gång för alla?
